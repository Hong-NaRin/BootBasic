...
@Controller
@RequestMapping("/view") // 폴더 경로에 맞춰서
public class ThymeleafController {
    ...
    @GetMapping("/ex03_result2/{name}/{age}") // 가변 매개변수로 뽑을 때는 매개변수에 중괄호를 써줌
    public String result2(@PathVariable("name") String name, // @PathVariable로 매개변수를 뽑아서 쓴다 ("name")
    ...
    public String quiz01_result(@ModelAttribute("num") String num) { // 다음 화면에서 num이라는 이름으로 쓸 수 있게 해줌
